...
function DetailResult({ isOpen, onClose, cardData }) {
  ...
  return (
    <ModalAlert onClose={onClose}>
      <div className="relative w-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl max-h-[90vh] overflow-auto">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex flex-col lg:w-1/2">
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="flex-1 px-6 py-4 space-y-4 overflow-y-auto max-h-60">
                {komentars.length === 0 ? (
