    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 md:px-4">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          >
            <div className="flex items-center justify-center w-20 h-20 rounded-2xl bg-primary-500/10">
              <img
                src={iconFrame}
                alt="Frame Icon"
                className="w-12 h-12"
            ...
            <div className="flex gap-3 mt-2">
              <div className="relative group">
                <img
                  src={Kartini}
                  alt="Sample frame 1"
                  className="object-cover transition-transform rounded-lg shadow-md w-14 h-14 group-hover:scale-110"
                />
                <div className="absolute inset-0 transition-opacity rounded-lg opacity-0 bg-gradient-to-t from-black/20 to-transparent group-hover:opacity-100" />
              </div>
              <div className="relative group">
                <img
                  src="/sample/frame2.jpg"
                  alt="Sample frame 2"
                  className="object-cover transition-transform rounded-lg shadow-md w-14 h-14 group-hover:scale-110"
                />
                <div className="absolute inset-0 transition-opacity rounded-lg opacity-0 bg-gradient-to-t from-black/20 to-transparent group-hover:opacity-100" />
          ...
          >
            <span className="absolute px-3 py-1 text-xs font-semibold text-white rounded-full shadow-sm bg-gradient-to-r from-primary-500 to-primary-600 top-3 right-3">
              Baru!
            </span>
            ...
            <p className="text-sm text-center text-gray-500">
              Variasi baru Twibbon berupa gambar background di belakang foto kamu
            </p>
